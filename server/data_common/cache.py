...
from server.common.errors import DatasetAccessError, DatasetNotFoundError, TombstoneException
...
class CacheManager(object):
    ...
    @contextmanager
    def get(self, cache_key: str, create_data_function: Optional[Callable] = None, create_data_args: object = {}):
        """
