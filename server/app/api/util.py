...
def get_dataset_artifact_s3_uri(url_dataroot: str = None, dataset_id: str = None):  # type: ignore
    dataset_artifact_s3_uri = get_dataset_metadata(url_dataroot, dataset_id, current_app.app_config)["s3_uri"]  # type: ignore
...
def get_data_adaptor(dataset_artifact_s3_uri: str) -> DataLoader:
    return DataLoader(location=dataset_artifact_s3_uri, app_config=current_app.app_config).validate_and_open()  # type: ignore
