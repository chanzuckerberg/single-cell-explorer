...
def pack_selector_from_mask(boolarray):  # type: ignore
    """
    ...
    return pack_selector_from_indices(selector)  # type: ignore


def pack_selector_from_indices(selector):  # type: ignore
    if len(selector) == 0:
        return None
