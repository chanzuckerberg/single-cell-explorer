...
from server.tests import PROJECT_ROOT, random_string


class TestPlugins(unittest.TestCase):
    """Test plugin import functionality"""

    plugins_dir = f"{PROJECT_ROOT}/server/tests/unit/plugins"
    ...
    def test_import_plugins(self):
        ...
        loaded_modules = import_plugins("server.tests.unit.plugins")
        # test that import plugins found the file
        self.assertEqual(["server.tests.unit.plugins.foo"], [ele.__name__ for ele in loaded_modules])
