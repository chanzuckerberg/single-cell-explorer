...
from server.tests.unit import BaseTestSparse as _BaseTest, skip_if
...
class BaseTest(_BaseTest):
    ...
    def setUpClass(cls, app_config=None):
        cls.TEST_S3_URI = f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg"
...
class TestDatasetMetadata(BaseTest):
    ...
    def setUpClass(cls):
        ...
        cls.meta_response_body = {
            ...
            "s3_uri": f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg",
            "tombstoned": False,
        }
...
class TestS3URI(BaseTest):
    ...
    def test_get_S3_URI_in_data_portal(self, mock_get):
        test_s3_uris = [
            (f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg", f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg"),
            (f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg/", f"{FIXTURES_ROOT}/pbmc3k_sparse.cxg"),
            (None, None),
        ]
        test_response_body = {
