...
class TestFixupGeneSymbols(unittest.TestCase):
    def setUp(self):
        self.seurat_path = f"{PROJECT_ROOT}/tests/fixtures/schema_test_data/seurat_tutorial.h5ad"
        self.seurat_merged_path = f"{PROJECT_ROOT}/tests/fixtures/schema_test_data/seurat_tutorial_merged.h5ad"
        self.sctransform_path = f"{PROJECT_ROOT}/tests/fixtures/schema_test_data/sctransform.h5ad"
        self.sctransform_merged_path = f"{PROJECT_ROOT}/tests/fixtures/schema_test_data/sctransform_merged.h5ad"
    ...
    def test_fixup_gene_symbols_seurat(self):
        ...
        if not os.path.isfile(self.seurat_path):
            return unittest.skip(
                ...
                "run tests/fixtures/schema_test_data/generate_test_data.sh"
            )
