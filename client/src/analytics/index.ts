...
export function trackColorByCategoryChangeEmbedding(
  isColorByCategory: boolean
): void {
...
export function trackColorByHistogramExpandCategoryFromColorByHistogram() {
...
export function trackColorByHistogramHighlightHistogramFromColorByHistogram() {
  return async (_: unknown, getState: GetState) => {
    const {
      colors: { colorMode },
      continuousSelection,
...
export function trackLassoChangeEmbedding() {
  return async (_: unknown, getState: GetState) => {
    const {
