        ...
        {writableCategoriesEnabled ? (
          <>
            <AnnoDialog
              ...
              annoInput={
                <LabelInput
                  // @ts-expect-error ts-migrate(2322) FIXME: Type '{ labelSuggestions: null; onChange: (name: string) => void; onSelect: (name: string) => void; inputProps: { "data-testid": string; leftIcon: string; intent: string; autoFocus: boolean; }; newLabelMessage: string; }' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<LabelInput> & Readonly<{}>'.
                  labelSuggestions={null}
                  onChange={this.handleNewCategoryNameChange}
                  onSelect={this.handleNewCategoryNameChange}
                  inputProps={{
