...
import {
  TypedArray,
  unionToTypedArray,
  unionListToTypedArray,
} from "../net-encoding/typed-array";
...
export class Matrix {
  ...
  colIndexType(): TypedArray {
    const offset = this.bb!.__offset(this.bb_pos, 10);
    return offset ? this.bb!.readUint8(this.bb_pos + offset) : TypedArray.NONE;
  }
  ...
  static addColIndexType(
    ...
    builder.addFieldInt8(3, colIndexType, TypedArray.NONE);
  }
  ...
  static addRowIndexType(
    ...
    builder.addFieldInt8(5, rowIndexType, TypedArray.NONE);
  }
