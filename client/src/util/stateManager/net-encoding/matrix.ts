...
import { TypedFBArray, unionToTypedFBArray, unionListToTypedFBArray } from '../net-encoding/typed-f-b-array';
...
static getRootAsMatrix(bb:flatbuffers.ByteBuffer, obj?:Matrix):Matrix {
  return (obj || new Matrix()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMatrix(bb:flatbuffers.ByteBuffer, obj?:Matrix):Matrix {
...
colIndexType():TypedFBArray {
  ...
  return offset ? this.bb!.readUint8(this.bb_pos + offset) : TypedFBArray.NONE;
}
...
static addColIndexType(builder:flatbuffers.Builder, colIndexType:TypedFBArray) {
  builder.addFieldInt8(3, colIndexType, TypedFBArray.NONE);
}

static addColIndex(builder:flatbuffers.Builder, colIndexOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, colIndexOffset, 0);
}

static addRowIndexType(builder:flatbuffers.Builder, rowIndexType:TypedFBArray) {
  builder.addFieldInt8(5, rowIndexType, TypedFBArray.NONE);
}

static addRowIndex(builder:flatbuffers.Builder, rowIndexOffset:flatbuffers.Offset) {
...
static finishMatrixBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedMatrixBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, undefined, true);
}

static createMatrix(builder:flatbuffers.Builder, nRows:number, nCols:number, columnsOffset:flatbuffers.Offset, colIndexType:TypedFBArray, colIndexOffset:flatbuffers.Offset, rowIndexType:TypedFBArray, rowIndexOffset:flatbuffers.Offset):flatbuffers.Offset {
