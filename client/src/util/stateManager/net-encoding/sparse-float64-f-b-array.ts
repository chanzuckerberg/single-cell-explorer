...
export class SparseFloat64FBArray {
  ...
  static getRootAsSparseFloat64FBArray(
    bb: flatbuffers.ByteBuffer,
    obj?: SparseFloat64FBArray
  ): SparseFloat64FBArray {
    return (obj || new SparseFloat64FBArray()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsSparseFloat64FBArray(
    bb: flatbuffers.ByteBuffer,
    obj?: SparseFloat64FBArray
  ): SparseFloat64FBArray {
  ...
  static endSparseFloat64FBArray(
    builder: flatbuffers.Builder
  ): flatbuffers.Offset {
  ...
  static createSparseFloat64FBArray(
    builder: flatbuffers.Builder,
    ...
    SparseFloat64FBArray.addSize(builder, sizeOffset);
